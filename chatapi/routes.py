from chatapi.models import User, Message, Text, Image, Video
from flask_jwt_extended import jwt_required, create_access_token, get_jwt_identity
from flask import request, jsonify, make_response, Response
from datetime import timedelta
from chatapi import app, db, bcrypt, jwt
from chatapi.schemas import serialize_query
...
def get_message():
    ...
    query = db.session.query(Message, Text, Image, Video) \
        ...
        .limit(limit) \
        .all()
    return jsonify({"messages": [serialize_query(q) for q in query]})
